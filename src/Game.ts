...
export function loadGame(fen: string, ctx: Ctx): GameState {
  ...
  let myGame: GameState = {
    ...
    moveRecords: {
      0: [[761,863],[710,812],[356,307],[504,506],[209,159]],
      1: [[827,879],[826,928],[825,927],[565,564],[828,830]],
      2: [],
      3: [[189,238],[139,137],[335,284],[435,335],[17,15]],
      4: [[1261,1360],[1212,1310],[1208,1260],[1454,1404]],
      5: [[1335,1433],[1031,1131],[1138,1237],[840,790]],
      6: [[1554,1505],[1603,1554],[1407,1456],[1408,1457],[1409,1458]],
      7: [[1732,1682],[1583,1584],[1683,1633],[1679,1630],[1585,1635]]
    },
    attackRecords: {
      0: null,
      1: [830, 'Arsenal'],
